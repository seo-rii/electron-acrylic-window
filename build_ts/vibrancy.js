...
function _setVibrancy(win, config) {
    if (config && config.colors) {
        ...
        bindings_1.default.setVibrancy(getHwnd(win), config.effect, config.colors.r, config.colors.g, config.colors.b, win.__electron_acrylic_window__.vibrnacyConfig.currentOpacity);
        ...
        debug_1.default("Vibrancy Off", config, win.__electron_acrylic_window__.vibrnacyConfig);
